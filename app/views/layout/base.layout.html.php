            ...
            <header class="flex justify-between items-center bg-white shadow-xl p-4 rounded-xl border border-gray-100 z-50">
                ...
                <div class="flex items-center space-x-4 group cursor-pointer">
                    ...
                    <div class="text-right">
                        <p class="text-gray-800 font-semibold leading-tight group-hover:text-primary transition duration-300"><?= $_SESSION['user']["prenom"] ?? 'Utilisateur' ?>
                        </p>
                        <p class="text-sm text-gray-500 group-hover:text-primary/80 transition duration-300"><?= $_SESSION['user']["nom"] ?? 'Utilisateur' ?>
                        </p>
                    </div>
                </div>
            </header>
